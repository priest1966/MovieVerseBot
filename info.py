...
MELCOW_VID = environ.get("MELCOW_VID", "https://graph.org/file/ea40f1b53dd3b6315c130.mp4") #https://graph.org/file/72dff2b65352ba85d0a34.mp4 
SPELL_IMG = environ.get("SPELL_IMG", "https://telegra.ph/file/5e2d4418525832bc9a1b9.jpg")
SUBSCRIPTION = (environ.get('SUBSCRIPTION', 'https://graph.org/file/e2d9b5e15e15daafb64e8.jpg'))
...
auth_channel = environ.get('AUTH_CHANNEL', '-1002050647275') #Channel / Group Id for force sub ( make sure bot is admin )
...
AI_LOGS = int(environ.get("AI_LOGS", "-1002125544878")) #GIVE YOUR NEW LOG CHANNEL ID TO STORE MESSAGES THAT THEY SEARCH IN BOT PM.... [ i have added this to keep an eye on the users message, to avoid misuse of Bot ]
...
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1002125544878')) #Log channel id ( make sure bot is admin )
...
S_GROUP = environ.get('S_GROUP', "movieverse_discussion_2")
S_CHANNEL = environ.get('S_CHANNEL', "movieversepremium")
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/movieverse_discussion_2')
CHNL_LNK = environ.get('CHNL_LNK', 'https://t.me/movieversepremium')
TUTORIAL = environ.get('TUTORIAL', 'https://t.me/howtoverify_97/3') # Tutorial video link for opening shortlink website 
...
INDEX_REQ_CHANNEL = int(environ.get('INDEX_REQ_CHANNEL', '-1002125544878'))
